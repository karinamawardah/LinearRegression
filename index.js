...
function intro () {
  let instruction = "Ketuk layar untuk menyisipkan poin data...."
  fill(250)
  noStroke()
  textFont('monospace')
  textSize(25)
  text("Linear Regression - Menggunakan TensorFlowJs", 15, 40)
  textSize(20)
  text(instruction, 15, windowHeight - 30)
  fill(250)
  textSize(15)
  text("Nama : Karina Mawardah ", windowWidth - 270, 40)
  text("Nim  : 181011400985", windowWidth - 270, 60)
  text("Kelas: 06TPLM006", windowWidth - 270, 80)
  text("UAS  : Kecerdasan Buatan", windowWidth - 270, 100)
  noFill();
  noStroke();
}
